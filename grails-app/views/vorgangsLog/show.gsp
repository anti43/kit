...
<html>
    ...
    <body>
        ...
        <div id="show-vorgangsLog" class="content scaffold-show" role="main">
            ...
            <f:display bean="vorgangsLog" />
            <g:form resource="${this.vorgangsLog}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.vorgangsLog}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
