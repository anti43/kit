...
<html>
    ...
    <body>
        ...
        <div id="edit-benutzer" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.benutzer}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.benutzer}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.benutzer}" method="PUT">
                <g:hiddenField name="version" value="${this.benutzer?.version}" />
                <fieldset class="form">
                    <f:all bean="benutzer"/>
                </fieldset>
