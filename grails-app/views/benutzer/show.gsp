...
<html>
    ...
    <body>
        ...
        <div id="show-benutzer" class="content scaffold-show" role="main">
            ...
            <f:display bean="benutzer" />
            <g:form resource="${this.benutzer}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.benutzer}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
